...
| Committing changes, finishing work, creating PRs, pushing code, linking Azure DevOps work items (`AB#`), creating feature branches (`feat/`), wrapping up tasks, "ship it", "I'm done" | `Skill("octo-commit", args: "<user's request>")` |
